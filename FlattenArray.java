public class FlattenArray {
    public static void main(String[] args) {
        ...
        for (int x = 0; x < r; x++) {
            for (int y = 0; y < c; y++) {
                System.out.print(TwoDArr[x][y] + " "); // mostrar los elementos de la fila separados por espacios
            }
        ...
        for (int x = 0; x < r; x++) {
            for (int y = 0; y < c; y++) {
                System.out.print(arr[x * r + y] + " "); // mostrar los elementos de la fila separados por espacios
            }
        }
    }
}
